...
def spatial_batchnorm_forward(x, gamma, beta, bn_param):
    ...
    # computation in one sweep by rearranging the dims to fit into the batchnorm_forward framework
...
def spatial_batchnorm_backward(dout, cache):
    ...
    dout_swapped_reshaped = np.reshape(dout_swapped, (-1, dout_swapped.shape[-1]))
