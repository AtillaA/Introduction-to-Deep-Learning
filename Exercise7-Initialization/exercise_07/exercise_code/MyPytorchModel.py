...
class MyPytorchModel(pl.LightningModule):
    ...
    def __init__(self, hparams, input_size=3 * 32 * 32, num_classes=10):
        ...
        # define a linear model with batch normalization & ReLU activation
        self.model = nn.Sequential(nn.Linear(input_size, 500),
                                   nn.BatchNorm1d(500),
                                   nn.ReLU(),
                                   nn.Dropout(p=0.5),
                                   nn.Linear(500, 100),
    ...
    def prepare_data(self):
        ...
        # REMARK: here 'RandomHorizontalFlip' and 'RandomResizeCrop' are randomly applied.
        # check different transformations to see how the accuracy changes
        my_transform = transforms.Compose([transforms.RandomApply((transforms.RandomHorizontalFlip(p=0.8),
    ...
    def configure_optimizers(self):
        ...
        # ADAM optimizer, implement other optimizers and compare their training speed & results
